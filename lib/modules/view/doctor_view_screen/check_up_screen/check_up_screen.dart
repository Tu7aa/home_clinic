...
class CheckUpScreen extends StatelessWidget {
  ...
  CheckUpScreen({this.date, this.time, this.address, this.doctorName, this.docId, this.doctorImage, this.doctorPrice});
  @override
  Widget build(BuildContext context) {
    var height = MediaQuery.of(context).size.height;
    return BlocProvider(create: (context)=> HomeClinicPatientCubit()..getprofile(),
    child: BlocConsumer<HomeClinicPatientCubit, HomeClinicPatientStates>(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  defaultText(
                                      text: (homeClinic.patientName != null) ? '${homeClinic.patientName}' : '...',
                                      color: '#262c3d',
                                      size: 18.0,
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      defaultText(
                                          text: (homeClinic.patientGender != null) ? '${homeClinic.patientGender}' : '...',
                                          color: '#262c3d',
                                          size: 14.0,
                                          textAlign: TextAlign.start,
                                          bold: true),
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      defaultText(
                                          text: (homeClinic.patientBirthDay != null) ? '${homeClinic.patientBirthDay}' : '...',
                                          color: '#262c3d',
                                          size: 14.0,
                                          textAlign: TextAlign.start,
                                          bold: true),
